...
SELECT [sighting_id], [scientific_name], [location_of_sighting], [sighting_date]
FROM [bird].[california_sightings]
UNION ALL
SELECT [sighting_id],[scientific_name],[sighting_location], [sighting_date]
FROM [bird].[arizona_sightings]
UNION ALL
SELECT[observation_id],[scientific_name], [locality], CAST([sighting_datetime] AS date)
